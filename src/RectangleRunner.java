...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle 1's area is: " + rect1.calculateArea() + ", box volume is: " + rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectangle 2's area is: " + rect2.calculateArea() + ", box volume is: " + rect2.calculateBoxVolume(rect2Height));
